...
function App() {
    ...
    return (<div className="App">
            <header className="App-header">
                ...
                <div>
                    <form>
                        <div>
                            <span>Filter by: </span>
                            <label>
                                <input type="radio" value="discount" checked={filter === 'discount'}
                                       onChange={() => setFilter('discount')}/>
                                Discount
                            </label>
                            <label>
                                <input type="radio" value="name" checked={filter === 'name'}
                ...
                <Carousel>
                    {itemData.map((item) => (<div key={item.id}>
                            <img src={item.image}/>
